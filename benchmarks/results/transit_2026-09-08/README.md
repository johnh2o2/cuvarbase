**Scope of this 8 September 2026 experiment:** its BLS competitor results remain current. Its TLS measurements concern the earlier phase-binned engine, retained as `method='binned'`, with a [subsequent binned-TLS study](../tls_sensitivity_2026-09-09/README.md) also archived. The [current transit report](../../../docs/TRANSIT_BENCHMARKS.md) covers the observation-level TLS default. The figure below retains the initial TLS comparison as historical evidence; measurements below retain their original interpretation.
