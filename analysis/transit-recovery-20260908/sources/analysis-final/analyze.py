...
def main():
    ...
    assert declared['operational_selection_sha256']==sha(r/'operational-selection.json')
    ...
    for profile in ['ztf','tess_200s','tess_gap']:
        for v1,competitor in [('bls_v1','bls_pypi'),('bls_v1','bls_cpu'),('bls_v1','bls_gpu'),('bls_v1_batch','bls_pypi'),
                              ('bls_v1_batch','bls_cpu'),('bls_v1_batch','bls_gpu'),('tls_v1','gtls'),('tls_v1','gtls_batch')]:
    ...
    result=dict(methods=summaries,comparisons=comparisons,verification=dict(errors=errors,output_arrays_checked=checked,arrays_verified=a.verify_arrays,complete=not errors))
