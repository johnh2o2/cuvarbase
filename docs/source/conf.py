# -*- coding: utf-8 -*-
#
# cuvarbase documentation build configuration file, created by
...
htmlhelp_basename = 'cuvarbasedoc'
...
latex_documents = [
    (master_doc, 'cuvarbase.tex', u'cuvarbase Documentation',
     u'John Hoffman', 'manual'),
]
