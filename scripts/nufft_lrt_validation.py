...
parts of the same configuration saw identical injections:
    python scripts/nufft_lrt_validation.py --configs white --arms lrt,bls,tls --out a.json
    python scripts/nufft_lrt_validation.py --configs white --arms lrt_auto --skip-calibration --out b.json
    python scripts/nufft_lrt_validation.py --configs red_sys,red_sys_nzm --out c.json
    ...
    python scripts/nufft_lrt_validation.py --merge a.json b.json c.json ... --out merged.json
